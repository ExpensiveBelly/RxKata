...
import kotlincollections.KotlinCollectionsExercises.Person
import kotlincollections.KotlinCollectionsExercises.Student
import org.assertj.core.api.Assertions.assertThat
import org.junit.Before
import org.junit.Test

class KotlinCollectionsExercisesTest {

    private lateinit var exercises: KotlinCollectionsExercises

    @Before
    fun setUp() {
        exercises = KotlinCollectionsExercises()
    }
    ...
    fun `counting items in a list after filter is applied`() {
        assertThat(exercises.`counting items in a list after filter is applied only items that start with t`()).isEqualTo(2)
    }
